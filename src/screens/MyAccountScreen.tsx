            ...
            {selectedTab === 'preview' ? (
              <>
                <p className="my-account-screen__notice">
                  Invoices listed here were not approved on time prior to payment period deadline,
                  and will NOT be paid until the next pay period. You&apos;ll still need to approve
                  these invoices prior to the NEXT pay period, which you&apos;ll be able to approve
                  at any time if the invoice shows up here.
                </p>
